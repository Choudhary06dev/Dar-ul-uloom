...
<section class="relative h-[600px] overflow-hidden">
    ...
    <div class="container mx-auto px-4 h-full flex flex-col justify-center items-center relative z-20 text-center text-white">
        <p class="text-gold text-xl font-medium mb-4 italic tracking-widest">بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ</p>
        <h1 class="text-5xl md:text-7xl font-bold mb-6 leading-tight">Welcome to <span class="text-gold">Dar-ul-uloom</span></h1>
        <p class="text-lg md:text-xl max-w-2xl mb-10 text-gray-200">
...
<section class="py-24 bg-white islamic-pattern">
    <div class="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div class="relative">
            ...
            <img src="{{ asset('assets/images/about.png') }}" alt="About Dar-ul-uloom" class="rounded-lg shadow-2xl relative z-10">
