...
// Admin routes: separate guard admin, and explicit path names for the admin panel
...
// Frontend authentication asset routes for regular web users (for existing tests)
